...
/**
 * 📋 Professional Report Template for Adiabatic Cooling Proposals
      ...
      <section className="executive-summary">
        ...
        <div className="key-highlights">
          ...
          <ul className="benefits-list">
            <li>Energy Cost Savings: ₹{formatters.currency(metrics.annualMonetarySaving)} per year</li>
            <li>CO₂ Reduction: {data.co2Reduction} kg annually</li>
          ...
          <table className="comparison-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>₹{safeCurrency(data.currentOperatingCost)}</td>
                <td>₹{formatters.currency(parseFloat(data.currentOperatingCost) - metrics.annualMonetarySaving)}</td>
                <td>₹{formatters.currency(metrics.annualMonetarySaving)}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="operating-conditions">
          ...
          <div className="conditions-grid">
            <div className="condition-item">
              ...
              <span className="value">{data.ambientTemperature}°C</span>
            </div>
            <div className="condition-item">
              <span className="label">Chilled Water Temperature:</span>
              <span className="value">{data.chillWaterTemperature}°C</span>
            </div>
            <div className="condition-item">
              <span className="label">Wet Bulb Temperature:</span>
              <span className="value">{data.wetBulbTemperature}°C</span>
            </div>
            <div className="condition-item">
          ...
          <table className="financial-table">
            <tbody>
              <tr>
                ...
                <td className="amount">₹{safeCurrency(data.investmentCost)}</td>
              </tr>
              <tr>
                <td>Annual Energy Savings</td>
                <td className="amount">₹{formatters.currency(metrics.annualMonetarySaving)}</td>
              </tr>
              <tr>
            ...
            <tbody>
              {Array.from({ length: 10 }, (_, i) => {
                ...
                return (
                  <tr key={year}>
                    <td>{year}</td>
                    <td>₹{formatters.currency(annualSavings)}</td>
                    <td>₹{formatters.currency(cumulativeSavings)}</td>
                    <td className={netBenefit > 0 ? 'positive' : 'negative'}>
                      ₹{formatters.currency(Math.abs(netBenefit))}
                    </td>
                  </tr>
                );
              })}
      ...
      <section className="environmental-impact">
        ...
        <div className="environmental-benefits">
          <div className="benefit-item">
            ...
            <p className="benefit-value">{data.co2Reduction} kg CO₂/year</p>
